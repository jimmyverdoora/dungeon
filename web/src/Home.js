    ...
    <div style={{ color: '#ffd480', fontFamily: 'monospace' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'center', fontSize: 'large' }}>
        <div>
          ...
          <p style={{ marginBottom: '2px', marginTop: 0 }}><span style={{ color: "#4aff47" }}>$</span> ALL money in 100% LIQUID GA$$$ (MATIC)</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'center', fontSize: 'large' }}>
        <div>
          ...
          <p style={{ marginBottom: 0, marginTop: 0 }}>| 10 MATIC to enter the 2D dungeon.</p>
          ...
          <p style={{ marginBottom: 0, marginTop: 0 }}>| The wood keys are not found inside and you have to buy from merchant for 10 MATIC.</p>
